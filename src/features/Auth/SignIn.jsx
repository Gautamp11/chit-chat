        ...
        <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            <div>
              ...
              <div className="mt-2">
                <input
                  ...
                  name="email"
                  type="email"
                  {...register("email", { required: "Enter mail correctly" })}
                  autoComplete="email"
            ...
            <div>
              ...
              <div className="mt-2">
                <input
                  ...
                  type="password"
                  {...register("password", {
                    required: "Enter password correctly",
                  })}
            ...
            <div>
              <button
                type="submit"
                className="flex w-full justify-center rounded-md bg-slate-600 px-3 py-1.5 text-sm font-semibold leading-6 text-slate-50 shadow-sm hover:bg-slate-700 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
              >
                Sign in
              </button>
            </div>
